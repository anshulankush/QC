...
public class ModelBusiness {
	...
	public static void LoadModel() {
		...
		ItemBusiness.add(new ItemBusiness(4, "bullet_point.gif", "Family"));
		ItemBusiness.add(new ItemBusiness(5, "bullet_point.gif","Food &  Dining"));
		ItemBusiness.add(new ItemBusiness(6, "bullet_point.gif","Health & Fitness"));
		ItemBusiness.add(new ItemBusiness(7, "bullet_point.gif","Realty"));
		ItemBusiness.add(new ItemBusiness(8, "bullet_point.gif","Services"));
		ItemBusiness.add(new ItemBusiness(9, "bullet_point.gif","Shopping"));
